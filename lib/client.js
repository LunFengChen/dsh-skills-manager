...
`;
  ...
  function observePluginUpdate(options) {
    ...
    function openDialog() {
      ...
      refreshDialog = () => {
        ...
        dialog.querySelector("[data-role=latest]").textContent = payload?.latestVersion === void 0 ? text.unknown : `v${payload.latestVersion}`;
        dialog.querySelector("[data-role=profile]").textContent = payload?.profileName ?? text.unknown;
        if (currentMessage !== void 0) status.textContent = typeof currentMessage === "function" ? currentMessage() : currentMessage;
      };
      refreshDialog();
  ...
  window.__ModuleLoader__.load({
    id: "@x1a0f3n9/dsh-skills-manager",
    factory: (require2) => {
      var module = { exports: {} };
      ...
      var DICT = {
        zh: {
          ...
          "summary.shadowed.one": "{count} \u4E2A\u88AB\u8986\u76D6",
          "summary.shadowed.other": "{count} \u4E2A\u88AB\u8986\u76D6",
          "summary.invalid.one": "{count} \u4E2A\u8BCA\u65AD\u5F02\u5E38",
          "summary.invalid.other": "{count} \u4E2A\u8BCA\u65AD\u5F02\u5E38",
          "table.skill": "\u6280\u80FD\u540D\u79F0\u4E0E\u63CF\u8FF0",
          "table.status": "\u8C03\u7528\u72B6\u6001",
          "filter.source": "\u6765\u6E90",
          "filter.all": "\u5168\u90E8\u6765\u6E90",
          ...
          "create.chat.note": "\u521B\u5EFA\u548C\u5BFC\u5165\u5747\u4FDD\u5B58\u5230\u5168\u5C40 DSH\uFF0C\u8DE8\u9879\u76EE\u53EF\u7528\u3002",
          "import.title": "\u5BFC\u5165\u6280\u80FD",
          ...
          "scope.projectHint": "\u4EC5\u5728\u5F53\u524D\u4F1A\u8BDD\u7684\u9879\u76EE\u4E2D\u751F\u6548\u3002\u542F\u505C\u4E0D\u4FEE\u6539\u5176\u4ED6 Agent \u7684\u6E90\u6587\u4EF6\u3002\u5BFC\u5165\u4ECD\u5199\u5165\u5168\u5C40 DSH\u3002",
          "project.empty": "\u5F53\u524D\u4F1A\u8BDD\u6CA1\u6709\u53EF\u8BC6\u522B\u7684\u9879\u76EE\u3002\u8BF7\u6253\u5F00 Git \u9879\u76EE\u4E2D\u7684\u4F1A\u8BDD\u3002",
          "filter.status": "\u8C03\u7528\u72B6\u6001",
          "filter.statusAll": "\u5168\u90E8\u72B6\u6001",
          "status.shadowedBy": "\u88AB {source} \u4E2D\u7684\u540C\u540D\u6280\u80FD\u8986\u76D6",
          "status.fallback.user": "\u5F53\u524D\u4F7F\u7528\u5168\u5C40 {source} \u526F\u672C\u3002",
          "status.fallback.project": "\u5F53\u524D\u4F7F\u7528\u9879\u76EE {source} \u526F\u672C\u3002",
          "root.copilot": "Copilot",
          "source.selectHint": "\u5148\u9009\u62E9\u4E00\u4E2A\u6765\u6E90\uFF0C\u624D\u80FD\u67E5\u770B\u76EE\u5F55\u6216\u5173\u95ED\u6574\u4E2A\u6765\u6E90\u3002\u5173\u95ED\u6765\u6E90\u53EA\u5F71\u54CD DSH \u8C03\u7528\uFF0C\u4E0D\u6539\u6587\u4EF6\u3002",
        ...
        en: {
          ...
          "summary.shadowed.one": "{count} shadowed",
          "summary.shadowed.other": "{count} shadowed",
          "summary.invalid.one": "{count} diagnostic",
          "summary.invalid.other": "{count} diagnostics",
          ...
          "create.globalTarget": "Global DSH",
          "create.name": "Name",
          ...
          "create.chat.note": "Created and imported skills are saved to global DSH and available across projects.",
          ...
          "scope.trash": "Trash",
          "scope.label": "Skill manager views",
          "scope.userHint": "Available across projects. Toggles only affect invocation in DSH.",
          "scope.projectHint": "Applies to the current session\u2019s project. Toggles do not modify other agents\u2019 source files. Import still writes to global DSH.",
          "project.empty": "The current session has no recognized project. Open a session in a Git project.",
          "filter.status": "Invocation status",
          "filter.statusAll": "All statuses",
          "status.shadowedBy": "Overridden by the same skill in {source}",
          "status.fallback.user": "Currently using the global {source} copy.",
          "status.fallback.project": "Currently using the project {source} copy.",
          "root.copilot": "Copilot",
          "source.selectHint": "Select a source to view its directory or turn the whole source off. Turning a source off only affects invocation in DSH and does not change files.",
          ...
          "root.projectSkills": "Project Skills",
          "root.codex": "Codex",
          "root.claude": "Claude",
          "root.gemini": "Gemini",
          "root.opencode": "OpenCode",
      ...
      var CSS2 = `
.dssm-tabs{display:flex;gap:24px;border-bottom:1px solid var(--dsw-alias-border-l2)}.dssm-tab{display:inline-flex;align-items:center;gap:6px;white-space:nowrap;padding:12px 2px;border:0;border-bottom:2px solid transparent;background:transparent;color:var(--dsw-alias-label-secondary);font:inherit;font-weight:600;cursor:pointer}.dssm-tab[aria-selected=true]{border-bottom-color:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary)}.dssm-tab:focus-visible{outline:2px solid var(--dsw-alias-state-success-primary);outline-offset:2px}.dssm-status-filter{width:140px;flex:none}.dssm-sources{gap:9px}.dssm-source{overflow:hidden;border:1px solid var(--dsw-alias-border-l2);border-radius:10px;background:var(--dsw-alias-bg-layer-2)}.dssm-source-head{display:flex;align-items:center;gap:10px;min-height:48px;padding:0 13px}.dssm-source-head-main{display:flex;align-items:center;gap:10px;flex:1;min-width:0;min-height:48px;padding:8px 0;border:0;background:transparent;color:inherit;font:inherit;text-align:left;cursor:pointer}.dssm-source-head-main:focus-visible{outline:2px solid var(--dsw-alias-state-success-primary);outline-offset:2px}.dssm-source-head:hover{background:var(--dsw-alias-interactive-bg-hover)}.dssm-source-chevron{flex:none;color:var(--dsw-alias-label-tertiary)}.dssm-source-title{font-size:14px;font-weight:650;overflow-wrap:anywhere}.dssm-source-head-main .dssm-count{flex:none}.dssm-source-path{min-width:0;margin-left:auto;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:11px}.dssm-source-actions{display:flex;flex:none;align-items:center}.dssm-source-body{border-top:1px solid var(--dsw-alias-border-l1)}.dssm-source-body[hidden]{display:none}.dssm-note{overflow-wrap:anywhere}.dssm-fallback{margin-top:4px;color:var(--dsw-alias-label-secondary)}.dssm-row .dssm-name{overflow-wrap:anywhere}
...
`;
      ...
      function formatTrashTime(t, value) {
        return new Date(value).toLocaleString(t("format.locale"));
      }
      ...
      function countSkillStatuses(list) {
        var summary = { total: list.length, enabled: 0, disabled: 0, shadowed: 0, invalid: 0 };
        list.forEach(function(row) {
          summary[skillStatus(row.skill)]++;
        });
        return summary;
      }
      function nextScopeTab(current, key) {
        var tabs = ["user", "project", "trash"], index = tabs.indexOf(current);
        if (key === "Home") return tabs[0];
        if (key === "End") return tabs[tabs.length - 1];
        if (key === "ArrowLeft" || key === "ArrowUp") return tabs[Math.max(0, index - 1)];
        if (key === "ArrowRight" || key === "ArrowDown") return tabs[Math.min(tabs.length - 1, index + 1)];
        return current;
      }
      function canToggleSource(root) {
        return !!(root && root.toggleable !== false && root.key !== "dsh" && root.kind !== "project-dsh");
      }
      ...
      function SkillManagerSection(props) {
        var sessionId = props.useSessions ? props.useSessions(function(snapshot) {
      ...
      function SkillManagerView(props) {
        ...
        function sessionApi(path, options2) {
          var headers = Object.assign({}, options2 && options2.headers);
        ...
        function refresh(silent) {
          ...
          return sessionApi("/state").then(function(data2) {
        ...
        function post(path, body, successKey, successParams) {
          ...
          setBusy(true);
          setResult(null);
          return sessionApi(path, { method: "POST", headers: MUTATION_HEADERS, body: JSON.stringify(body || {}) }).then(function(data2) {
        ...
        function openDetail(root, skill) {
          ...
          setDetail(null);
          setModal("detail");
          sessionApi("/detail", { method: "POST", headers: MUTATION_HEADERS, body: JSON.stringify({ root: root.key, name: skill.name }) }).then(setDetail).catch(function(error) {
            setResult({ ok: false, text: t("error.action", { error: translateError(t, error) }) });
            setModal(null);
          }).finally(function() {
            setBusy(false);
        ...
        var roots = scope === "trash" ? [] : scopeSkillRoots(allRoots, scope, activeProject), activeSource = roots.some(function(root) {
          return root.key === source;
        }) ? source : "";
        var createRoot = allRoots.find(function(root) {
          return root.key === "dsh" && root.mutable === true;
        });
        function openCreate() {
          if (!createRoot) return;
          setForm(Object.assign({}, form, { root: "dsh" }));
          setModal("create");
        }
        ...
        function renderFallback(skill) {
          ...
          var target = allRoots.find(function(root) {
            return root.key === skill.fallbackTo.root;
          });
        ...
        function renderSkill(root, skill) {
          ...
          return h("div", { key: root.key + ":" + skill.name, className: "dssm-row" }, h("div", { className: "dssm-main" }, h("div", { className: "dssm-name" }, skill.declaredName || skill.name), renderFallback(skill)), h("div", { className: "dssm-tags" }, h("span", { className: "dssm-tag", title: root.path }, t("root." + (root.localeKey || root.key))), !root.mutable ? h("span", { className: "dssm-tag" }, t("status.readonly")) : null), h("div", { className: "dssm-status " + cls, title: skill.shadowedBy ? t("status.shadowedBy", { source: function() {
            var winner = allRoots.find(function(item) {
              return item.key === skill.shadowedBy.root;
            });
            return winner ? rootDisplayName(t, winner) : skill.shadowedBy.root;
          }() }) : void 0 }, t(key)), h("div", { className: "dssm-row-actions" }, root.toggleable !== false ? h(Switch, { on: enabled, disabled: busy || root.enabled === false || skill.loadable === false, label: t("skill.toggle") + " " + skill.name, onClick: function() {
        ...
        function renderRoot(root) {
          var filtered = filteredRows.filter(function(row) {
            return row.root.key === root.key;
          });
          ...
          var open = expanded[expansionKey] === void 0 ? !!(query || activeSource || filters.status) : expanded[expansionKey];
          var panelId = "dssm-source-" + encodeURIComponent(root.key), displayName = rootDisplayName(t, root);
          return h(
            "section",
            { key: root.key, className: "dssm-source" },
            h(
              "div",
              { className: "dssm-source-head" },
              h(
                "button",
                { type: "button", className: "dssm-source-head-main", "aria-expanded": open, "aria-controls": panelId, onClick: function() {
                  setExpanded(function(previous) {
                    return Object.assign({}, previous, { [expansionKey]: !open });
                  });
                } },
                h("span", { className: "dssm-source-chevron", "aria-hidden": true }, open ? "\u25BE" : "\u25B8"),
                h("span", { className: "dssm-source-title" }, displayName),
                h("span", { className: "dssm-count" }, t(countKey("summary.group", filtered.length), { count: filtered.length })),
                h("span", { className: "dssm-source-path", title: root.path }, root.path)
              ),
              canToggleSource(root) ? h("span", { className: "dssm-source-actions" }, h(Switch, { on: root.enabled, disabled: busy, label: t("source.toggle") + " " + displayName, onClick: function() {
                post(root.enabled ? "/source-disable" : "/source-enable", { root: root.key });
              } })) : null
            ),
            h("div", { id: panelId, className: "dssm-source-body", hidden: !open }, open ? filtered.length ? h(
              react.Fragment,
              null,
              h("div", { className: "dssm-table-head" }, h("span", null, t("table.skill")), h("span", null, t("filter.source")), h("span", null, t("table.status")), h("span", null, "")),
              filtered.map(function(row) {
                return renderSkill(root, row.skill);
              })
            ) : h("div", { className: "dssm-empty" }, t("empty.source")) : null)
          );
        }
        function renderList() {
        ...
        function renderTrash() {
          return h("div", { key: "trash", id: "dssm-scope-panel", role: "tabpanel", "aria-labelledby": "dssm-tab-trash", className: "dssm-trash-panel" }, h("div", { className: "dssm-count" }, t(countKey("trash.count", data.trash.length), { count: data.trash.length })), data.trash.length ? data.trash.map(function(item) {
            return h("div", { key: item.id, className: "dssm-trash-item" }, h("div", { className: "dssm-trash-main" }, h("div", { className: "dssm-name" }, item.name), h("div", { className: "dssm-note" }, t("trash.deletedAt", { time: formatTrashTime(t, item.deletedAt) }) + " \xB7 " + t("trash.source", { source: trashRootLabel(item) }))), h("button", { className: "dssm-btn dssm-btn-quiet", disabled: busy, onClick: function() {
              post("/trash-restore", { id: item.id }, "result.restored", { name: item.name }).catch(function() {
              });
        ...
        var tabs = h("div", { key: "tabs", className: "dssm-tabs", role: "tablist", "aria-label": t("scope.label") }, ["user", "project", "trash"].map(function(value) {
        ...
        var skillControls = [h("div", { key: "summary", className: "dssm-summary" }, [["total", "summary.total"], ["enabled", "summary.enabled"], ["disabled", "summary.disabled"], ["invalid", "summary.invalid"]].map(function(item) {
          return h("div", { key: item[1], className: "dssm-stat" }, h("strong", null, summary[item[0]]), t(countKey(item[1], summary[item[0]]), { count: summary[item[0]] }).replace(String(summary[item[0]]), ""));
        ...
        var content = [h("style", { key: "css" }, CSS2), h("div", { key: "head", className: "dssm-head" }, h("div", { className: "dssm-title-block" }, h("div", { className: "dssm-title-row" }, h("h2", { className: "dssm-title" }, t("title")), h("div", { className: "dssm-feedback-links" }, h("a", { className: "dssm-feedback-link", href: "https://github.com/MichengAI/dsh-skills-manager", target: "_blank", rel: "noreferrer", "aria-label": t("link.project") }, h(GithubMark16, null), t("link.project")), h("a", { className: "dssm-feedback-link", href: "https://github.com/MichengAI/dsh-skills-manager/issues", target: "_blank", rel: "noreferrer", "aria-label": t("link.feedback") }, h(primitives.IconListPenOutline16, null), t("link.feedback")))), h("p", { className: "dssm-desc" }, t("desc"))), h("div", { className: "dssm-actions" }, h("button", { type: "button", className: "dssm-btn dssm-btn-secondary", disabled: busy || snapshot.loading, onClick: function() {
          refresh(false);
        } }, t("btn.refresh")), scope !== "trash" ? h("button", { type: "button", className: "dssm-btn", disabled: busy || !createRoot, onClick: openCreate }, t("btn.create")) : null, scope !== "trash" ? h("button", { type: "button", className: "dssm-btn dssm-btn-secondary", onClick: function() {
          setResult(null);
          setUpload(null);
          setModal("import");
        } }, t("import.global")) : null)), tabs].concat(scope === "trash" ? [] : skillControls, [result && modal !== "import" ? h("div", { key: "result", className: "dssm-feedback" + (result.warning ? " dssm-warning" : result.ok ? "" : " dssm-error") }, result.text) : null], (data.warnings || []).map(function(warning, index) {
          return h("div", { key: "warning-" + index, className: "dssm-feedback dssm-warning", role: "alert" }, translateError(t, warning));
        }), [snapshot.error ? h("div", { key: "error", className: "dssm-feedback dssm-error" }, snapshot.error) : null, snapshot.loading && !snapshot.data ? h("div", { key: "loading", className: "dssm-empty" }, t("loading")) : scope === "trash" ? renderTrash() : renderList()]);
        if (modal === "create") content.push(h(Modal, { key: "create", title: t("create.title"), closeLabel: t("btn.close"), onClose: function() {
          setModal(null);
        } }, h("div", { className: "dssm-form" }, h("label", { className: "dssm-field" }, h("span", { className: "dssm-label" }, t("create.target")), h("div", { className: "dssm-detail-path" }, t("create.globalTarget"), createRoot && createRoot.path ? " \xB7 " + createRoot.path : "")), [["name", "create.name", "create.name.placeholder"], ["description", "create.description", "create.description.placeholder"]].map(function(field) {
      ...
      function apply(ctx) {
        ...
        ctx.effect(function() {
          return observePluginUpdate({ endpoint: "/api/michengai/dsh-skills-manager/update", packageName: "@x1a0f3n9/dsh-skills-manager", titleRowSelector: ".dssm-title-row", linksSelector: ".dssm-feedback-links", zhName: "\u6280\u80FD", enName: "Skills", createIcon: createPluginUpdateIcon });
